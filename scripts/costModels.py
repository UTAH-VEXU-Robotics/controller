...
from driver.msg import Model, Models, Type, Types, Zone, Zones, ChangeUpGoal, ChangeUpGoals, ChangeUpField, Action, Actions, Task, Tasks
...
def main():
    ...
    rospy.Subscriber('/field/models', Models, modelCallback)
...
#            print(main.tasks.tasks)
            ...
            main.bestTaskDone = False

            if(main.bestTaskDone == False):
                main.bestTaskDone = True
